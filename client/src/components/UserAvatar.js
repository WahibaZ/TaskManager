...
import { logout } from "../redux/slices/authSlice"; // Import de l'action logout
import { useNavigate } from "react-router-dom"; // Si vous souhaitez rediriger après la déconnexion


const UserAvatar = () => {
  const [/* open,  */setOpen] = useState(false);
  const [/* openPassword,  */setOpenPassword] = useState(false);
  const dispatch = useDispatch(); // Création d'une instance de dispatch
